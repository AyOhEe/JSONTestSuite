...
programs = {
    "Java AyOhEe JavaJSON":
        {
            "url":"https://github.com/AyOhEe/JavaJSON",
            "commands":["C:/Users/User/.jdks/openjdk-22.0.1/bin/java.exe", "-jar", os.path.join(PARSERS_DIR, "test_JavaJSON", "JavaJson.jar")]
        }
}
